...
!function s(){m++;for(var a=0;h.lines>a;a++)l=Math.max(1-(m+(h.lines-a)*r)%p*q,h.opacity),f.opacity(i,a*h.direction+n,l,h);f.timeout=f.el&&setTimeout(s,~~(1e3/o))}()}return f},stop:function(){var a=this.el;return a&&(clearTimeout(this.timeout),a.parentNode&&a.parentNode.removeChild(a),this.el=void 0),this},lines:function(d,f){function g(b,c){return e(a(),{position:"absolute",width:f.length+f.width+"px",height:f.width+"px",background:b,boxShadow:c,transformOrigin:"left",transform:"rotate("+~~(360/f.lines*i+f.rotate)+"deg) translate("+f.radius+"px,0)",borderRadius:(f.corners*f.width>>1)+"px"})}for(var h,i=0,k=(f.lines-1)*(1-f.direction)/2;f.lines>i;i++)h=e(a(),{position:"absolute",top:1+~(f.width/2)+"px",transform:f.hwaccel?"translate3d(0,0,0)":"",opacity:f.opacity,animation:j&&c(f.opacity,f.trail,k+i*f.direction,f.lines)+" "+1/f.speed+"s linear infinite"}),f.shadow&&b(h,e(g("#000","0 0 4px #000"),{top:"2px"})),b(d,b(h,g(f.color,"0 0 1px rgba(0,0,0,.1)")));return d},opacity:function(a,b,c){a.childNodes.length>b&&(a.childNodes[b].style.opacity=c)}});var o=e(a("group"),{behavior:"url(#default#VML)"});return!d(o,"transform")&&o.adj?i():j=d(o,"animation"),h}),function(a,b){"object"==typeof exports?module.exports=b():"function"==typeof define&&define.amd?define(["spin"],b):a.Ladda=b(a.Spinner)}(this,function(a){"use strict";function b(a){if(void 0===a)return void console.warn("Ladda button target must be defined.");a.querySelector(".ladda-label")||(a.innerHTML='<span class="ladda-label">'+a.innerHTML+"</span>");var b,c=document.createElement("span");c.className="ladda-spinner",a.appendChild(c);var d,e={start:function(){return b||(b=g(a)),a.setAttribute("disabled",""),a.setAttribute("data-loading",""),clearTimeout(d),b.spin(c),this.setProgress(0),this},startAfter:function(a){return clearTimeout(d),d=setTimeout(function(){e.start()},a),this},stop:function(){return a.removeAttribute("disabled"),a.removeAttribute("data-loading"),clearTimeout(d),b&&(d=setTimeout(function(){b.stop()},1e3)),this},toggle:function(){return this.isLoading()?this.stop():this.start(),this},setProgress:function(b){b=Math.max(Math.min(b,1),0);var c=a.querySelector(".ladda-progress");0===b&&c&&c.parentNode?c.parentNode.removeChild(c):(c||(c=document.createElement("div"),c.className="ladda-progress",a.appendChild(c)),c.style.width=(b||0)*a.offsetWidth+"px")},enable:function(){return this.stop(),this},disable:function(){return this.stop(),a.setAttribute("disabled",""),this},isLoading:function(){return a.hasAttribute("data-loading")}};return i.push(e),e}function c(a,b){for(;a.parentNode&&a.tagName!==b;)a=a.parentNode;return b===a.tagName?a:void 0}function d(a){for(var b=["input","textarea"],c=[],d=0;b.length>d;d++)for(var e=a.getElementsByTagName(b[d]),f=0;e.length>f;f++)e[f].hasAttribute("required")&&c.push(e[f]);return c}function e(a,e){e=e||{};var f=[];"string"==typeof a?f=h(document.querySelectorAll(a)):"object"==typeof a&&"string"==typeof a.nodeName&&(f=[a]);for(var g=0,i=f.length;i>g;g++)(function(){var a=f[g];if("function"==typeof a.addEventListener){var h=b(a),i=-1;a.addEventListener("click",function(){var b=!0,f=c(a,"FORM");if(void 0!==f)for(var g=d(f),j=0;g.length>j;j++)""===g[j].value.replace(/^\s+|\s+$/g,"")&&(b=!1);b&&(h.startAfter(1),"number"==typeof e.timeout&&(clearTimeout(i),i=setTimeout(h.stop,e.timeout)),"function"==typeof e.callback&&e.callback.apply(null,[h]))},!1)}})()}function f(){for(var a=0,b=i.length;b>a;a++)i[a].stop()}function g(b){var c,d=b.offsetHeight;0===d&&(d=parseFloat(window.getComputedStyle(b).height)),d>32&&(d*=.8),b.hasAttribute("data-spinner-size")&&(d=parseInt(b.getAttribute("data-spinner-size"),10)),b.hasAttribute("data-spinner-color")&&(c=b.getAttribute("data-spinner-color"));var e=12,f=.2*d,g=.6*f,h=7>f?2:3;return new a({color:c||"#fff",lines:e,radius:f,length:g,width:h,zIndex:"auto",top:"auto",left:"auto",className:""})}function h(a){for(var b=[],c=0;a.length>c;c++)b.push(a[c]);return b}var i=[];return{bind:e,create:b,stopAll:f}}),function(){function a(a,b,c){c=(c||0)-1;for(var d=a?a.length:0;++c<d;)if(a[c]===b)return c;return-1}function b(b,c){var d=typeof c;if(b=b.l,"boolean"==d||null==c)return b[c]?0:-1;"number"!=d&&"string"!=d&&(d="object");var e="number"==d?c:r+c;return b=(b=b[d])&&b[e],"object"==d?b&&-1<a(b,c)?0:-1:b?0:-1}function c(a){var b=this.l,c=typeof a;if("boolean"==c||null==a)b[a]=!0;else{"number"!=c&&"string"!=c&&(c="object");var d="number"==c?a:r+a,b=b[c]||(b[c]={});"object"==c?(b[d]||(b[d]=[])).push(a):b[d]=!0}}function d(a){return a.charCodeAt(0)}function e(a,b){var c=a.m,d=b.m;if(c!==d){if(c>d||"undefined"==typeof c)return 1;if(d>c||"undefined"==typeof d)return-1}return a.n-b.n}function f(a){var b=-1,d=a.length,e=a[0],f=a[d/2|0],g=a[d-1];if(e&&"object"==typeof e&&f&&"object"==typeof f&&g&&"object"==typeof g)return!1;for(e=i(),e["false"]=e["null"]=e["true"]=e.undefined=!1,f=i(),f.k=a,f.l=e,f.push=c;++b<d;)f.push(a[b]);return f}function g(a){return"\\"+U[a]}function h(){return o.pop()||[]}function i(){return p.pop()||{k:null,l:null,m:null,"false":!1,n:0,"null":!1,number:null,object:null,push:null,string:null,"true":!1,undefined:!1,o:null}}function j(a){a.length=0,o.length<t&&o.push(a)}function k(a){var b=a.l;b&&k(b),a.k=a.l=a.m=a.object=a.number=a.string=a.o=null,p.length<t&&p.push(a)}function l(a,b,c){b||(b=0),"undefined"==typeof c&&(c=a?a.length:0);var d=-1;c=c-b||0;for(var e=Array(0>c?0:c);++d<c;)e[d]=a[b+d];return e}function m(c){function o(a){if(!a||nc.call(a)!=N)return!1;var b=a.valueOf,c="function"==typeof b&&(c=tc(b))&&tc(c);return c?a==c||tc(a)==c:qb(a)}function p(a,b,c){if(!a||!T[typeof a])return a;b=b&&"undefined"==typeof c?b:eb(b,c,3);for(var d=-1,e=T[typeof a]&&Oc(a),f=e?e.length:0;++d<f&&(c=e[d],!1!==b(a[c],c,a)););return a}function t(a,b,c){var d;if(!a||!T[typeof a])return a;b=b&&"undefined"==typeof c?b:eb(b,c,3);for(d in a)if(!1===b(a[d],d,a))break;return a}function U(a,b,c){var d,e=a,f=e;if(!e)return f;for(var g=arguments,h=0,i="number"==typeof c?2:g.length;++h<i;)if((e=g[h])&&T[typeof e])for(var j=-1,k=T[typeof e]&&Oc(e),l=k?k.length:0;++j<l;)d=k[j],"undefined"==typeof f[d]&&(f[d]=e[d]);return f}function W(a,b,c){var d,e=a,f=e;if(!e)return f;var g=arguments,h=0,i="number"==typeof c?2:g.length;if(i>3&&"function"==typeof g[i-2])var j=eb(g[--i-1],g[i--],2);else i>2&&"function"==typeof g[i-1]&&(j=g[--i]);for(;++h<i;)if((e=g[h])&&T[typeof e])for(var k=-1,l=T[typeof e]&&Oc(e),m=l?l.length:0;++k<m;)d=l[k],f[d]=j?j(f[d],e[d]):e[d];return f}function X(a){var b,c=[];if(!a||!T[typeof a])return c;for(b in a)uc.call(a,b)&&c.push(b);return c}function _(a){return a&&"object"==typeof a&&!Nc(a)&&uc.call(a,"__wrapped__")?a:new ab(a)}function ab(a,b){this.__chain__=!!b,this.__wrapped__=a}function bb(a){function b(){if(d){var a=d.slice();wc.apply(a,arguments)}if(this instanceof b){var f=db(c.prototype),a=c.apply(f,a||arguments);return xb(a)?a:f}return c.apply(e,a||arguments)}var c=a[0],d=a[2],e=a[4];return Mc(b,a),b}function cb(a,b,c,d,e){if(c){var f=c(a);if("undefined"!=typeof f)return f}if(!xb(a))return a;var g=nc.call(a);if(!Q[g])return a;var i=Kc[g];switch(g){case J:case K:return new i(+a);case M:case P:return new i(a);case O:return f=i(a.source,z.exec(a)),f.lastIndex=a.lastIndex,f}if(g=Nc(a),b){var k=!d;d||(d=h()),e||(e=h());for(var m=d.length;m--;)if(d[m]==a)return e[m];f=g?i(a.length):{}}else f=g?l(a):W({},a);return g&&(uc.call(a,"index")&&(f.index=a.index),uc.call(a,"input")&&(f.input=a.input)),b?(d.push(a),e.push(f),(g?Fb:p)(a,function(a,g){f[g]=cb(a,b,c,d,e)}),k&&(j(d),j(e)),f):f}function db(a){return xb(a)?Bc(a):{}}function eb(a,b,c){if("function"!=typeof a)return Yb;if("undefined"==typeof b||!("prototype"in a))return a;var d=a.__bindData__;if("undefined"==typeof d&&(Lc.funcNames&&(d=!a.name),d=d||!Lc.funcDecomp,!d)){var e=sc.call(a);Lc.funcNames||(d=!A.test(e)),d||(d=E.test(e),Mc(a,d))}if(!1===d||!0!==d&&1&d[1])return a;switch(c){case 1:return function(c){return a.call(b,c)};case 2:return function(c,d){return a.call(b,c,d)};case 3:return function(c,d,e){return a.call(b,c,d,e)};case 4:return function(c,d,e,f){return a.call(b,c,d,e,f)}}return Vb(a,b)}function fb(a){function b(){var a=i?g:this;if(e){var o=e.slice();wc.apply(o,arguments)}return(f||k)&&(o||(o=l(arguments)),f&&wc.apply(o,f),k&&o.length<h)?(d|=16,fb([c,m?d:-4&d,o,null,g,h])):(o||(o=arguments),j&&(c=a[n]),this instanceof b?(a=db(c.prototype),o=c.apply(a,o),xb(o)?o:a):c.apply(a,o))}var c=a[0],d=a[1],e=a[2],f=a[3],g=a[4],h=a[5],i=1&d,j=2&d,k=4&d,m=8&d,n=c;return Mc(b,a),b}function gb(c,d){var e=-1,g=pb(),h=c?c.length:0,i=h>=s&&g===a,j=[];if(i){var l=f(d);l?(g=b,d=l):i=!1}for(;++e<h;)l=c[e],0>g(d,l)&&j.push(l);return i&&k(d),j}function hb(a,b,c,d){d=(d||0)-1;for(var e=a?a.length:0,f=[];++d<e;){var g=a[d];if(g&&"object"==typeof g&&"number"==typeof g.length&&(Nc(g)||sb(g))){b||(g=hb(g,b,c));var h=-1,i=g.length,j=f.length;for(f.length+=i;++h<i;)f[j++]=g[h]}else c||f.push(g)}return f}function ib(a,b,c,d,e,f){if(c){var g=c(a,b);if("undefined"!=typeof g)return!!g}if(a===b)return 0!==a||1/a==1/b;if(a===a&&!(a&&T[typeof a]||b&&T[typeof b]))return!1;if(null==a||null==b)return a===b;var i=nc.call(a),k=nc.call(b);if(i==H&&(i=N),k==H&&(k=N),i!=k)return!1;switch(i){case J:case K:return+a==+b;case M:return a!=+a?b!=+b:0==a?1/a==1/b:a==+b;case O:case P:return a==ic(b)}if(k=i==I,!k){var l=uc.call(a,"__wrapped__"),m=uc.call(b,"__wrapped__");if(l||m)return ib(l?a.__wrapped__:a,m?b.__wrapped__:b,c,d,e,f);if(i!=N)return!1;if(i=a.constructor,l=b.constructor,i!=l&&!(wb(i)&&i instanceof i&&wb(l)&&l instanceof l)&&"constructor"in a&&"constructor"in b)return!1}for(l=!e,e||(e=h()),f||(f=h()),i=e.length;i--;)if(e[i]==a)return f[i]==b;var n=0,g=!0;if(e.push(a),f.push(b),k){if(i=a.length,n=b.length,g=n==a.length,!g&&!d)return g;for(;n--;)if(k=i,l=b[n],d)for(;k--&&!(g=ib(a[k],l,c,d,e,f)););else if(!(g=ib(a[n],l,c,d,e,f)))break;return g}return t(b,function(b,h,i){return uc.call(i,h)?(n++,g=uc.call(a,h)&&ib(a[h],b,c,d,e,f)):void 0}),g&&!d&&t(a,function(a,b,c){return uc.call(c,b)?g=-1<--n:void 0}),l&&(j(e),j(f)),g}function jb(a,b,c,d,e){(Nc(b)?Fb:p)(b,function(b,f){var g,h,i=b,j=a[f];if(b&&((h=Nc(b))||o(b))){for(i=d.length;i--;)if(g=d[i]==b){j=e[i];break}if(!g){var k;c&&(i=c(j,b),k="undefined"!=typeof i)&&(j=i),k||(j=h?Nc(j)?j:[]:o(j)?j:{}),d.push(b),e.push(j),k||jb(j,b,c,d,e)}}else c&&(i=c(j,b),"undefined"==typeof i&&(i=b)),"undefined"!=typeof i&&(j=i);a[f]=j})}function kb(a,b){return a+rc(Jc()*(b-a+1))}function lb(c,d,e){var g=-1,i=pb(),l=c?c.length:0,m=[],n=!d&&l>=s&&i===a,o=e||n?h():m;if(n){var p=f(o);p?(i=b,o=p):(n=!1,o=e?o:(j(o),m))}for(;++g<l;){var p=c[g],q=e?e(p,g,c):p;(d?!g||o[o.length-1]!==q:0>i(o,q))&&((e||n)&&o.push(q),m.push(p))}return n?(j(o.k),k(o)):e&&j(o),m}function mb(a){return function(b,c,d){var e={};c=_.createCallback(c,d,3),d=-1;var f=b?b.length:0;if("number"==typeof f)for(;++d<f;){var g=b[d];a(e,g,c(g,d,b),b)}else p(b,function(b,d,f){a(e,b,c(b,d,f),f)});return e}}function nb(a,b,c,d,e,f){var g=1&b,h=4&b,i=16&b,j=32&b;if(!(2&b||wb(a)))throw new jc;i&&!c.length&&(b&=-17,i=c=!1),j&&!d.length&&(b&=-33,j=d=!1);var k=a&&a.__bindData__;return k&&!0!==k?(k=k.slice(),!g||1&k[1]||(k[4]=e),!g&&1&k[1]&&(b|=8),!h||4&k[1]||(k[5]=f),i&&wc.apply(k[2]||(k[2]=[]),c),j&&wc.apply(k[3]||(k[3]=[]),d),k[1]|=b,nb.apply(null,k)):(1==b||17===b?bb:fb)([a,b,c,d,e,f])}function ob(a){return Pc[a]}function pb(){var b=(b=_.indexOf)===Pb?a:b;return b}function qb(a){var b,c;return a&&nc.call(a)==N&&(b=a.constructor,!wb(b)||b instanceof b)?(t(a,function(a,b){c=b}),"undefined"==typeof c||uc.call(a,c)):!1}function rb(a){return Qc[a]}function sb(a){return a&&"object"==typeof a&&"number"==typeof a.length&&nc.call(a)==H||!1}function tb(a,b,c){var d=Oc(a),e=d.length;for(b=eb(b,c,3);e--&&(c=d[e],!1!==b(a[c],c,a)););return a}function ub(a){var b=[];return t(a,function(a,c){wb(a)&&b.push(c)}),b.sort()}function vb(a){for(var b=-1,c=Oc(a),d=c.length,e={};++b<d;){var f=c[b];e[a[f]]=f}return e}function wb(a){return"function"==typeof a}function xb(a){return!(!a||!T[typeof a])}function yb(a){return"number"==typeof a||a&&"object"==typeof a&&nc.call(a)==M||!1}function zb(a){return"string"==typeof a||a&&"object"==typeof a&&nc.call(a)==P||!1}function Ab(a){for(var b=-1,c=Oc(a),d=c.length,e=ac(d);++b<d;)e[b]=a[c[b]];return e}function Bb(a,b,c){var d=-1,e=pb(),f=a?a.length:0,g=!1;return c=(0>c?Gc(0,f+c):c)||0,Nc(a)?g=-1<e(a,b,c):"number"==typeof f?g=-1<(zb(a)?a.indexOf(b,c):e(a,b,c)):p(a,function(a){return++d<c?void 0:!(g=a===b)}),g}function Cb(a,b,c){var d=!0;b=_.createCallback(b,c,3),c=-1;var e=a?a.length:0;if("number"==typeof e)for(;++c<e&&(d=!!b(a[c],c,a)););else p(a,function(a,c,e){return d=!!b(a,c,e)});return d}function Db(a,b,c){var d=[];b=_.createCallback(b,c,3),c=-1;var e=a?a.length:0;if("number"==typeof e)for(;++c<e;){var f=a[c];b(f,c,a)&&d.push(f)}else p(a,function(a,c,e){b(a,c,e)&&d.push(a)});return d}function Eb(a,b,c){b=_.createCallback(b,c,3),c=-1;var d=a?a.length:0;if("number"!=typeof d){var e;return p(a,function(a,c,d){return b(a,c,d)?(e=a,!1):void 0}),e}for(;++c<d;){var f=a[c];if(b(f,c,a))return f}}function Fb(a,b,c){var d=-1,e=a?a.length:0;if(b=b&&"undefined"==typeof c?b:eb(b,c,3),"number"==typeof e)for(;++d<e&&!1!==b(a[d],d,a););else p(a,b);return a}function Gb(a,b,c){var d=a?a.length:0;if(b=b&&"undefined"==typeof c?b:eb(b,c,3),"number"==typeof d)for(;d--&&!1!==b(a[d],d,a););else{var e=Oc(a),d=e.length;p(a,function(a,c,f){return c=e?e[--d]:--d,b(f[c],c,f)})}return a}function Hb(a,b,c){var d=-1,e=a?a.length:0;if(b=_.createCallback(b,c,3),"number"==typeof e)for(var f=ac(e);++d<e;)f[d]=b(a[d],d,a);else f=[],p(a,function(a,c,e){f[++d]=b(a,c,e)});return f}function Ib(a,b,c){var e=-1/0,f=e;if("function"!=typeof b&&c&&c[b]===a&&(b=null),null==b&&Nc(a)){c=-1;for(var g=a.length;++c<g;){var h=a[c];h>f&&(f=h)}}else b=null==b&&zb(a)?d:_.createCallback(b,c,3),Fb(a,function(a,c,d){c=b(a,c,d),c>e&&(e=c,f=a)});return f}function Jb(a,b){var c=-1,d=a?a.length:0;if("number"==typeof d)for(var e=ac(d);++c<d;)e[c]=a[c][b];return e||Hb(a,b)}function Kb(a,b,c,d){if(!a)return c;var e=3>arguments.length;b=_.createCallback(b,d,4);var f=-1,g=a.length;if("number"==typeof g)for(e&&(c=a[++f]);++f<g;)c=b(c,a[f],f,a);else p(a,function(a,d,f){c=e?(e=!1,a):b(c,a,d,f)});return c}function Lb(a,b,c,d){var e=3>arguments.length;return b=_.createCallback(b,d,4),Gb(a,function(a,d,f){c=e?(e=!1,a):b(c,a,d,f)}),c}function Mb(a){var b=-1,c=a?a.length:0,d=ac("number"==typeof c?c:0);return Fb(a,function(a){var c=kb(0,++b);d[b]=d[c],d[c]=a}),d}function Nb(a,b,c){var d;b=_.createCallback(b,c,3),c=-1;var e=a?a.length:0;if("number"==typeof e)for(;++c<e&&!(d=b(a[c],c,a)););else p(a,function(a,c,e){return!(d=b(a,c,e))});return!!d}function Ob(a,b,c){var d=0,e=a?a.length:0;if("number"!=typeof b&&null!=b){var f=-1;for(b=_.createCallback(b,c,3);++f<e&&b(a[f],f,a);)d++}else if(d=b,null==d||c)return a?a[0]:n;return l(a,0,Hc(Gc(0,d),e))}function Pb(b,c,d){if("number"==typeof d){var e=b?b.length:0;d=0>d?Gc(0,e+d):d||0}else if(d)return d=Rb(b,c),b[d]===c?d:-1;return a(b,c,d)}function Qb(a,b,c){if("number"!=typeof b&&null!=b){var d=0,e=-1,f=a?a.length:0;for(b=_.createCallback(b,c,3);++e<f&&b(a[e],e,a);)d++}else d=null==b||c?1:Gc(0,b);return l(a,d)}function Rb(a,b,c,d){var e=0,f=a?a.length:e;for(c=c?_.createCallback(c,d,1):Yb,b=c(b);f>e;)d=e+f>>>1,c(a[d])<b?e=d+1:f=d;return e}function Sb(a,b,c,d){return"boolean"!=typeof b&&null!=b&&(d=c,c="function"!=typeof b&&d&&d[b]===a?null:b,b=!1),null!=c&&(c=_.createCallback(c,d,3)),lb(a,b,c)}function Tb(){for(var a=1<arguments.length?arguments:arguments[0],b=-1,c=a?Ib(Jb(a,"length")):0,d=ac(0>c?0:c);++b<c;)d[b]=Jb(a,b);return d}function Ub(a,b){for(var c=-1,d=a?a.length:0,e={};++c<d;){var f=a[c];b?e[f]=b[c]:f&&(e[f[0]]=f[1])}return e}function Vb(a,b){return 2<arguments.length?nb(a,17,l(arguments,2),null,b):nb(a,1,null,null,b)}function Wb(a,b,c){function d(){k&&qc(k),g=k=l=n,(p||o!==b)&&(m=vc(),h=a.apply(j,f),k||g||(f=j=null))}function e(){var c=b-(vc()-i);c>0?k=xc(e,c):(g&&qc(g),c=l,g=k=l=n,c&&(m=vc(),h=a.apply(j,f),k||g||(f=j=null)))}var f,g,h,i,j,k,l,m=0,o=!1,p=!0;if(!wb(a))throw new jc;if(b=Gc(0,b)||0,!0===c)var q=!0,p=!1;else xb(c)&&(q=c.leading,o="maxWait"in c&&(Gc(b,c.maxWait)||0),p="trailing"in c?c.trailing:p);return function(){if(f=arguments,i=vc(),j=this,l=p&&(k||!q),!1===o)var c=q&&!k;else{g||q||(m=i);var n=o-(i-m),r=0>=n;r?(g&&(g=qc(g)),m=i,h=a.apply(j,f)):g||(g=xc(d,n))}return r&&k?k=qc(k):k||b===o||(k=xc(e,b)),c&&(r=!0,h=a.apply(j,f)),!r||k||g||(f=j=null),h}}function Xb(a){if(!wb(a))throw new jc;var b=l(arguments,1);return xc(function(){a.apply(n,b)},1)}function Yb(a){return a}function Zb(a,b){var c=a,d=!b||wb(c);b||(c=ab,b=a,a=_),Fb(ub(b),function(e){var f=a[e]=b[e];d&&(c.prototype[e]=function(){var b=this.__wrapped__,d=[b];return wc.apply(d,arguments),d=f.apply(a,d),b&&"object"==typeof b&&b===d?this:(d=new c(d),d.__chain__=this.__chain__,d)})})}function $b(){}function _b(){return this.__wrapped__}c=c?$.defaults(V.Object(),c,$.pick(V,G)):V;var ac=c.Array,bc=c.Boolean,cc=c.Date,dc=c.Function,ec=c.Math,fc=c.Number,gc=c.Object,hc=c.RegExp,ic=c.String,jc=c.TypeError,kc=[],lc=gc.prototype,mc=c._,nc=lc.toString,oc=hc("^"+ic(nc).replace(/[.*+?^${}()|[\]\\]/g,"\\$&").replace(/toString| for [^\]]+/g,".*?")+"$"),pc=ec.ceil,qc=c.clearTimeout,rc=ec.floor,sc=dc.prototype.toString,tc=oc.test(tc=gc.getPrototypeOf)&&tc,uc=lc.hasOwnProperty,vc=oc.test(vc=cc.now)&&vc||function(){return+new cc},wc=kc.push,xc=c.setTimeout,yc=kc.splice,zc="function"==typeof(zc=Z&&Y&&Z.setImmediate)&&!oc.test(zc)&&zc,Ac=function(){try{var a={},b=oc.test(b=gc.defineProperty)&&b,c=b(a,a,a)&&b}catch(d){}return c}(),Bc=oc.test(Bc=gc.create)&&Bc,Cc=oc.test(Cc=ac.isArray)&&Cc,Dc=c.isFinite,Ec=c.isNaN,Fc=oc.test(Fc=gc.keys)&&Fc,Gc=ec.max,Hc=ec.min,Ic=c.parseInt,Jc=ec.random,Kc={};Kc[I]=ac,Kc[J]=bc,Kc[K]=cc,Kc[L]=dc,Kc[N]=gc,Kc[M]=fc,Kc[O]=hc,Kc[P]=ic,ab.prototype=_.prototype;var Lc=_.support={};Lc.funcDecomp=!oc.test(c.a)&&E.test(m),Lc.funcNames="string"==typeof dc.name,_.templateSettings={escape:/<%-([\s\S]+?)%>/g,evaluate:/<%([\s\S]+?)%>/g,interpolate:B,variable:"",imports:{_:_}},Bc||(db=function(){function a(){}return function(b){if(xb(b)){a.prototype=b;var d=new a;a.prototype=null}return d||c.Object()}}());var Mc=Ac?function(a,b){S.value=b,Ac(a,"__bindData__",S)}:$b,Nc=Cc||function(a){return a&&"object"==typeof a&&"number"==typeof a.length&&nc.call(a)==I||!1},Oc=Fc?function(a){return xb(a)?Fc(a):[]}:X,Pc={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Qc=vb(Pc),Rc=hc("("+Oc(Qc).join("|")+")","g"),Sc=hc("["+Oc(Pc).join("")+"]","g"),Tc=mb(function(a,b,c){uc.call(a,c)?a[c]++:a[c]=1}),Uc=mb(function(a,b,c){(uc.call(a,c)?a[c]:a[c]=[]).push(b)}),Vc=mb(function(a,b,c){a[c]=b});zc&&(Xb=function(a){if(!wb(a))throw new jc;return zc.apply(c,arguments)});var Wc=8==Ic(u+"08")?Ic:function(a,b){return Ic(zb(a)?a.replace(C,""):a,b||0)};return _.after=function(a,b){if(!wb(b))throw new jc;return function(){return 1>--a?b.apply(this,arguments):void 0}},_.assign=W,_.at=function(a){for(var b=arguments,c=-1,d=hb(b,!0,!1,1),b=b[2]&&b[2][b[1]]===a?1:d.length,e=ac(b);++c<b;)e[c]=a[d[c]];return e},_.bind=Vb,_.bindAll=function(a){for(var b=1<arguments.length?hb(arguments,!0,!1,1):ub(a),c=-1,d=b.length;++c<d;){var e=b[c];a[e]=nb(a[e],1,null,null,a)}return a},_.bindKey=function(a,b){return 2<arguments.length?nb(b,19,l(arguments,2),null,a):nb(b,3,null,null,a)},_.chain=function(a){return a=new ab(a),a.__chain__=!0,a},_.compact=function(a){for(var b=-1,c=a?a.length:0,d=[];++b<c;){var e=a[b];e&&d.push(e)}return d},_.compose=function(){for(var a=arguments,b=a.length;b--;)if(!wb(a[b]))throw new jc;return function(){for(var b=arguments,c=a.length;c--;)b=[a[c].apply(this,b)];return b[0]}},_.countBy=Tc,_.create=function(a,b){var c=db(a);return b?W(c,b):c},_.createCallback=function(a,b,c){var d=typeof a;if(null==a||"function"==d)return eb(a,b,c);if("object"!=d)return function(b){return b[a]};var e=Oc(a),f=e[0],g=a[f];return 1!=e.length||g!==g||xb(g)?function(b){for(var c=e.length,d=!1;c--&&(d=ib(b[e[c]],a[e[c]],null,!0)););return d}:function(a){return a=a[f],g===a&&(0!==g||1/g==1/a)}},_.curry=function(a,b){return b="number"==typeof b?b:+b||a.length,nb(a,4,null,null,null,b)},_.debounce=Wb,_.defaults=U,_.defer=Xb,_.delay=function(a,b){if(!wb(a))throw new jc;var c=l(arguments,2);return xc(function(){a.apply(n,c)},b)},_.difference=function(a){return gb(a,hb(arguments,!0,!0,1))},_.filter=Db,_.flatten=function(a,b,c,d){return"boolean"!=typeof b&&null!=b&&(d=c,c="function"!=typeof b&&d&&d[b]===a?null:b,b=!1),null!=c&&(a=Hb(a,c,d)),hb(a,b)},_.forEach=Fb,_.forEachRight=Gb,_.forIn=t,_.forInRight=function(a,b,c){var d=[];t(a,function(a,b){d.push(b,a)});var e=d.length;for(b=eb(b,c,3);e--&&!1!==b(d[e--],d[e],a););return a},_.forOwn=p,_.forOwnRight=tb,_.functions=ub,_.groupBy=Uc,_.indexBy=Vc,_.initial=function(a,b,c){var d=0,e=a?a.length:0;if("number"!=typeof b&&null!=b){var f=e;for(b=_.createCallback(b,c,3);f--&&b(a[f],f,a);)d++}else d=null==b||c?1:b||d;return l(a,0,Hc(Gc(0,e-d),e))},_.intersection=function(c){for(var d=arguments,e=d.length,g=-1,i=h(),l=-1,m=pb(),n=c?c.length:0,o=[],p=h();++g<e;){var q=d[g];i[g]=m===a&&(q?q.length:0)>=s&&f(g?d[g]:p)}a:for(;++l<n;){var r=i[0],q=c[l];if(0>(r?b(r,q):m(p,q))){for(g=e,(r||p).push(q);--g;)if(r=i[g],0>(r?b(r,q):m(d[g],q)))continue a;o.push(q)}}for(;e--;)(r=i[e])&&k(r);return j(i),j(p),o},_.invert=vb,_.invoke=function(a,b){var c=l(arguments,2),d=-1,e="function"==typeof b,f=a?a.length:0,g=ac("number"==typeof f?f:0);return Fb(a,function(a){g[++d]=(e?b:a[b]).apply(a,c)}),g},_.keys=Oc,_.map=Hb,_.max=Ib,_.memoize=function(a,b){function c(){var d=c.cache,e=b?b.apply(this,arguments):r+arguments[0];return uc.call(d,e)?d[e]:d[e]=a.apply(this,arguments)}if(!wb(a))throw new jc;return c.cache={},c},_.merge=function(a){var b=arguments,c=2;if(!xb(a))return a;if("number"!=typeof b[2]&&(c=b.length),c>3&&"function"==typeof b[c-2])var d=eb(b[--c-1],b[c--],2);else c>2&&"function"==typeof b[c-1]&&(d=b[--c]);for(var b=l(arguments,1,c),e=-1,f=h(),g=h();++e<c;)jb(a,b[e],d,f,g);return j(f),j(g),a},_.min=function(a,b,c){var e=1/0,f=e;if("function"!=typeof b&&c&&c[b]===a&&(b=null),null==b&&Nc(a)){c=-1;for(var g=a.length;++c<g;){var h=a[c];f>h&&(f=h)}}else b=null==b&&zb(a)?d:_.createCallback(b,c,3),Fb(a,function(a,c,d){c=b(a,c,d),e>c&&(e=c,f=a)});return f},_.omit=function(a,b,c){var d={};if("function"!=typeof b){var e=[];t(a,function(a,b){e.push(b)});for(var e=gb(e,hb(arguments,!0,!1,1)),f=-1,g=e.length;++f<g;){var h=e[f];d[h]=a[h]}}else b=_.createCallback(b,c,3),t(a,function(a,c,e){b(a,c,e)||(d[c]=a)});return d},_.once=function(a){var b,c;if(!wb(a))throw new jc;return function(){return b?c:(b=!0,c=a.apply(this,arguments),a=null,c)}},_.pairs=function(a){for(var b=-1,c=Oc(a),d=c.length,e=ac(d);++b<d;){var f=c[b];e[b]=[f,a[f]]}return e},_.partial=function(a){return nb(a,16,l(arguments,1))},_.partialRight=function(a){return nb(a,32,null,l(arguments,1))},_.pick=function(a,b,c){var d={};if("function"!=typeof b)for(var e=-1,f=hb(arguments,!0,!1,1),g=xb(a)?f.length:0;++e<g;){var h=f[e];h in a&&(d[h]=a[h])}else b=_.createCallback(b,c,3),t(a,function(a,c,e){b(a,c,e)&&(d[c]=a)});return d},_.pluck=Jb,_.pull=function(a){for(var b=arguments,c=0,d=b.length,e=a?a.length:0;++c<d;)for(var f=-1,g=b[c];++f<e;)a[f]===g&&(yc.call(a,f--,1),e--);return a},_.range=function(a,b,c){a=+a||0,c="number"==typeof c?c:+c||1,null==b&&(b=a,a=0);var d=-1;b=Gc(0,pc((b-a)/(c||1)));for(var e=ac(b);++d<b;)e[d]=a,a+=c;return e},_.reject=function(a,b,c){return b=_.createCallback(b,c,3),Db(a,function(a,c,d){return!b(a,c,d)})},_.remove=function(a,b,c){var d=-1,e=a?a.length:0,f=[];for(b=_.createCallback(b,c,3);++d<e;)c=a[d],b(c,d,a)&&(f.push(c),yc.call(a,d--,1),e--);return f},_.rest=Qb,_.shuffle=Mb,_.sortBy=function(a,b,c){var d=-1,f=a?a.length:0,g=ac("number"==typeof f?f:0);for(b=_.createCallback(b,c,3),Fb(a,function(a,c,e){var f=g[++d]=i();f.m=b(a,c,e),f.n=d,f.o=a}),f=g.length,g.sort(e);f--;)a=g[f],g[f]=a.o,k(a);return g},_.tap=function(a,b){return b(a),a},_.throttle=function(a,b,c){var d=!0,e=!0;if(!wb(a))throw new jc;return!1===c?d=!1:xb(c)&&(d="leading"in c?c.leading:d,e="trailing"in c?c.trailing:e),R.leading=d,R.maxWait=b,R.trailing=e,Wb(a,b,R)},_.times=function(a,b,c){a=-1<(a=+a)?a:0;var d=-1,e=ac(a);for(b=eb(b,c,1);++d<a;)e[d]=b(d);return e},_.toArray=function(a){return a&&"number"==typeof a.length?l(a):Ab(a)},_.transform=function(a,b,c,d){var e=Nc(a);if(null==c)if(e)c=[];else{var f=a&&a.constructor;c=db(f&&f.prototype)}return b&&(b=_.createCallback(b,d,4),(e?Fb:p)(a,function(a,d,e){return b(c,a,d,e)})),c},_.union=function(){return lb(hb(arguments,!0,!0))},_.uniq=Sb,_.values=Ab,_.where=Db,_.without=function(a){return gb(a,l(arguments,1))},_.wrap=function(a,b){return nb(b,16,[a])},_.zip=Tb,_.zipObject=Ub,_.collect=Hb,_.drop=Qb,_.each=Fb,_.eachRight=Gb,_.extend=W,_.methods=ub,_.object=Ub,_.select=Db,_.tail=Qb,_.unique=Sb,_.unzip=Tb,Zb(_),_.clone=function(a,b,c,d){return"boolean"!=typeof b&&null!=b&&(d=c,c=b,b=!1),cb(a,b,"function"==typeof c&&eb(c,d,1))},_.cloneDeep=function(a,b,c){return cb(a,!0,"function"==typeof b&&eb(b,c,1))},_.contains=Bb,_.escape=function(a){return null==a?"":ic(a).replace(Sc,ob)},_.every=Cb,_.find=Eb,_.findIndex=function(a,b,c){var d=-1,e=a?a.length:0;for(b=_.createCallback(b,c,3);++d<e;)if(b(a[d],d,a))return d;return-1},_.findKey=function(a,b,c){var d;return b=_.createCallback(b,c,3),p(a,function(a,c,e){return b(a,c,e)?(d=c,!1):void 0}),d},_.findLast=function(a,b,c){var d;return b=_.createCallback(b,c,3),Gb(a,function(a,c,e){return b(a,c,e)?(d=a,!1):void 0}),d},_.findLastIndex=function(a,b,c){var d=a?a.length:0;for(b=_.createCallback(b,c,3);d--;)if(b(a[d],d,a))return d;return-1},_.findLastKey=function(a,b,c){var d;return b=_.createCallback(b,c,3),tb(a,function(a,c,e){return b(a,c,e)?(d=c,!1):void 0}),d},_.has=function(a,b){return a?uc.call(a,b):!1},_.identity=Yb,_.indexOf=Pb,_.isArguments=sb,_.isArray=Nc,_.isBoolean=function(a){return!0===a||!1===a||a&&"object"==typeof a&&nc.call(a)==J||!1},_.isDate=function(a){return a&&"object"==typeof a&&nc.call(a)==K||!1},_.isElement=function(a){return a&&1===a.nodeType||!1},_.isEmpty=function(a){var b=!0;if(!a)return b;var c=nc.call(a),d=a.length;return c==I||c==P||c==H||c==N&&"number"==typeof d&&wb(a.splice)?!d:(p(a,function(){return b=!1}),b)},_.isEqual=function(a,b,c,d){return ib(a,b,"function"==typeof c&&eb(c,d,2))},_.isFinite=function(a){return Dc(a)&&!Ec(parseFloat(a))},_.isFunction=wb,_.isNaN=function(a){return yb(a)&&a!=+a},_.isNull=function(a){return null===a},_.isNumber=yb,_.isObject=xb,_.isPlainObject=o,_.isRegExp=function(a){return a&&"object"==typeof a&&nc.call(a)==O||!1},_.isString=zb,_.isUndefined=function(a){return"undefined"==typeof a},_.lastIndexOf=function(a,b,c){var d=a?a.length:0;for("number"==typeof c&&(d=(0>c?Gc(0,d+c):Hc(c,d-1))+1);d--;)if(a[d]===b)return d;return-1},_.mixin=Zb,_.noConflict=function(){return c._=mc,this},_.noop=$b,_.parseInt=Wc,_.random=function(a,b,c){var d=null==a,e=null==b;return null==c&&("boolean"==typeof a&&e?(c=a,a=1):e||"boolean"!=typeof b||(c=b,e=!0)),d&&e&&(b=1),a=+a||0,e?(b=a,a=0):b=+b||0,c||a%1||b%1?(c=Jc(),Hc(a+c*(b-a+parseFloat("1e-"+((c+"").length-1))),b)):kb(a,b)},_.reduce=Kb,_.reduceRight=Lb,_.result=function(a,b){if(a){var c=a[b];return wb(c)?a[b]():c}},_.runInContext=m,_.size=function(a){var b=a?a.length:0;return"number"==typeof b?b:Oc(a).length},_.some=Nb,_.sortedIndex=Rb,_.template=function(a,b,c){var d=_.templateSettings;a=ic(a||""),c=U({},c,d);var e,f=U({},c.imports,d.imports),d=Oc(f),f=Ab(f),h=0,i=c.interpolate||D,j="__p+='",i=hc((c.escape||D).source+"|"+i.source+"|"+(i===B?y:D).source+"|"+(c.evaluate||D).source+"|$","g");a.replace(i,function(b,c,d,f,i,k){return d||(d=f),j+=a.slice(h,k).replace(F,g),c&&(j+="'+__e("+c+")+'"),i&&(e=!0,j+="';"+i+";\n__p+='"),d&&(j+="'+((__t=("+d+"))==null?'':__t)+'"),h=k+b.length,b}),j+="';",i=c=c.variable,i||(c="obj",j="with("+c+"){"+j+"}"),j=(e?j.replace(v,""):j).replace(w,"$1").replace(x,"$1;"),j="function("+c+"){"+(i?"":c+"||("+c+"={});")+"var __t,__p='',__e=_.escape"+(e?",__j=Array.prototype.join;function print(){__p+=__j.call(arguments,'')}":";")+j+"return __p}";try{var k=dc(d,"return "+j).apply(n,f)}catch(l){throw l.source=j,l}return b?k(b):(k.source=j,k)},_.unescape=function(a){return null==a?"":ic(a).replace(Rc,rb)},_.uniqueId=function(a){var b=++q;return ic(null==a?"":a)+b},_.all=Cb,_.any=Nb,_.detect=Eb,_.findWhere=Eb,_.foldl=Kb,_.foldr=Lb,_.include=Bb,_.inject=Kb,p(_,function(a,b){_.prototype[b]||(_.prototype[b]=function(){var b=[this.__wrapped__],c=this.__chain__;return wc.apply(b,arguments),b=a.apply(_,b),c?new ab(b,c):b})}),_.first=Ob,_.last=function(a,b,c){var d=0,e=a?a.length:0;if("number"!=typeof b&&null!=b){var f=e;for(b=_.createCallback(b,c,3);f--&&b(a[f],f,a);)d++}else if(d=b,null==d||c)return a?a[e-1]:n;return l(a,Gc(0,e-d))},_.sample=function(a,b,c){return a&&"number"!=typeof a.length&&(a=Ab(a)),null==b||c?a?a[kb(0,a.length-1)]:n:(a=Mb(a),a.length=Hc(Gc(0,b),a.length),a)},_.take=Ob,_.head=Ob,p(_,function(a,b){var c="sample"!==b;_.prototype[b]||(_.prototype[b]=function(b,d){var e=this.__chain__,f=a(this.__wrapped__,b,d);return e||null!=b&&(!d||c&&"function"==typeof b)?new ab(f,e):f})}),_.VERSION="2.3.0",_.prototype.chain=function(){return this.__chain__=!0,this},_.prototype.toString=function(){return ic(this.__wrapped__)},_.prototype.value=_b,_.prototype.valueOf=_b,Fb(["join","pop","shift"],function(a){var b=kc[a];_.prototype[a]=function(){var a=this.__chain__,c=b.apply(this.__wrapped__,arguments);return a?new ab(c,a):c}}),Fb(["push","reverse","sort","unshift"],function(a){var b=kc[a];_.prototype[a]=function(){return b.apply(this.__wrapped__,arguments),this}}),Fb(["concat","slice","splice"],function(a){var b=kc[a];_.prototype[a]=function(){return new ab(b.apply(this.__wrapped__,arguments),this.__chain__)}}),_}var n,o=[],p=[],q=0,r=+new Date+"",s=75,t=40,u=" 	\f ﻿\n\r\u2028\u2029 ᠎             　",v=/\b__p\+='';/g,w=/\b(__p\+=)''\+/g,x=/(__e\(.*?\)|\b__t\))\+'';/g,y=/\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g,z=/\w*$/,A=/^\s*function[ \n\r\t]+\w/,B=/<%=([\s\S]+?)%>/g,C=RegExp("^["+u+"]*0+(?=.$)"),D=/($^)/,E=/\bthis\b/,F=/['\n\r\t\u2028\u2029\\]/g,G="Array Boolean Date Function Math Number Object RegExp String _ attachEvent clearTimeout isFinite isNaN parseInt setImmediate setTimeout".split(" "),H="[object Arguments]",I="[object Array]",J="[object Boolean]",K="[object Date]",L="[object Function]",M="[object Number]",N="[object Object]",O="[object RegExp]",P="[object String]",Q={};Q[L]=!1,Q[H]=Q[I]=Q[J]=Q[K]=Q[M]=Q[N]=Q[O]=Q[P]=!0;var R={leading:!1,maxWait:0,trailing:!1},S={configurable:!1,enumerable:!1,value:null,writable:!1},T={"boolean":!1,"function":!0,object:!0,number:!1,string:!1,undefined:!1},U={"\\":"\\","'":"'","\n":"n","\r":"r","	":"t","\u2028":"u2028","\u2029":"u2029"},V=T[typeof window]&&window||this,W=T[typeof exports]&&exports&&!exports.nodeType&&exports,X=T[typeof module]&&module&&!module.nodeType&&module,Y=X&&X.exports===W&&W,Z=T[typeof global]&&global;!Z||Z.global!==Z&&Z.window!==Z||(V=Z);var $=m();"function"==typeof define&&"object"==typeof define.amd&&define.amd?(V._=$,define(function(){return $})):W&&X?Y?(X.exports=$)._=$:W._=$:V._=$}.call(this);